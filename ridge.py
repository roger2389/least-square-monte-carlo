...
def ridge_lsmc(S, K, T, r, sigma, M, N, alpha, option='put', seed=123):
    ...
    for t in range(N-1, 0, -1):
        ...
        # Calculate continuation values using the ridge model
...
alpha = 0.1  # Ridge regression regularization parameter

mc_mean = []
mc_std = []
for n in M:
    m, s = ridge_lsmc(S, K, T, r, sigma, n, N, alpha)
    mc_mean.append(m)
    mc_std.append(s)
...
plt.title(f'S={S}, K={K}, T={T}, r={r}, $\sigma$={sigma}, option={option}, ridge', fontsize=14)
